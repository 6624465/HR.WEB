    ...
    public class AdministrationController : BaseController
    {
        ...
        public ActionResult Company(int companyId = 0)
        {
            ...
            using (HrDataContext dbContext = new HrDataContext())
            {
                ...
                if (address != null)
                {
                    companyvm.companyAddress.Address1 = (address.Address1 == null ? "" : address.Address1);
                    companyvm.companyAddress.Address2 = (address.Address2 == null ? "" : address.Address2);
                    companyvm.companyAddress.Address3 = (address.Address3 == null ? "" : address.Address3);
                    companyvm.companyAddress.Address4 = (address.Address4 == null ? "" : address.Address4);
                    companyvm.companyAddress.Address5 = (address.Address5 == null ? "" : address.Address5);
                    companyvm.companyAddress.Address6 = (address.Address6 == null ? "" : address.Address6);
                    companyvm.companyAddress.Address7 = (address.Address7 == null ? "" : address.Address7);
                    companyvm.companyAddress.Address8 = (address.Address8 == null ? "" : address.Address8);
                    companyvm.companyAddress.Address9 = (address.Address9 == null ? "" : address.Address9);
                    companyvm.companyAddress.Address10 = (address.Address10 == null ? "" : address.Address10);
                    companyvm.companyAddress.Address11 = (address.Address11 == null ? "" : address.Address11);
                    companyvm.companyAddress.Address12 = (address.Address12 == null ? "" : address.Address12);
                    companyvm.companyAddress.Address13 = (address.Address13 == null ? "" : address.Address13);
                    companyvm.companyAddress.AddressId = address.AddressId;
                    companyvm.companyAddress.AddressType = address.AddressType;
                    companyvm.companyAddress.CityName = (address.CityName == null ? "" : address.CityName);
                    companyvm.companyAddress.Contact = (address.Contact == null ? "" : address.Contact);
                    companyvm.companyAddress.CountryCode = (address.CountryCode == null ? "" : address.CountryCode);
                    ...
                    companyvm.companyAddress.MobileNo = (address.MobileNo == null ? "" : address.MobileNo);
        ...
        public ActionResult AddBranch(int branchId = 0)
        {
            ...
            using (HrDataContext dbContext = new HrDataContext())
            {
                ...
                {
                    branchVm.address.Address1 = (address.Address1 == null ? "" : address.Address1);
                    branchVm.address.Address2 = (address.Address2 == null ? "" : address.Address2);
                    branchVm.address.Address3 = (address.Address3 == null ? "" : address.Address3);
                    branchVm.address.Address4 = (address.Address4 == null ? "" : address.Address4);
                    branchVm.address.Address5 = (address.Address5 == null ? "" : address.Address5);
                    branchVm.address.Address6 = (address.Address6 == null ? "" : address.Address6);
                    branchVm.address.Address7 = (address.Address7 == null ? "" : address.Address7);
                    branchVm.address.Address8 = (address.Address8 == null ? "" : address.Address8);
                    branchVm.address.Address9 = (address.Address9 == null ? "" : address.Address9);
                    branchVm.address.Address10 = (address.Address10 == null ? "" : address.Address10);
                    branchVm.address.Address11 = (address.Address11 == null ? "" : address.Address11);
                    branchVm.address.Address12 = (address.Address12 == null ? "" : address.Address12);
                    branchVm.address.Address13 = (address.Address13 == null ? "" : address.Address13);
                    branchVm.address.AddressId = address.AddressId;
                    branchVm.address.AddressType = address.AddressType;
                    branchVm.address.CityName = (address.CityName == null ? "" : address.CityName);
                    branchVm.address.Contact = (address.Contact == null ? "" : address.Contact);
                    branchVm.address.CountryCode = (address.CountryCode==null?"": address.CountryCode);
                    ...
                    branchVm.address.MobileNo = (address.MobileNo == null ? "" : address.MobileNo);
